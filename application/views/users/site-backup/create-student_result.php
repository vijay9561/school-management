...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Upload Student Result</li>
			</ol>
		<div class="col-md-12">
		...
		<label>Upload File(Only Upload .csv file)</label>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<?php $student_master=$this->db->query("select *from tbl_parent where pid='$pid' and Student_class_division='$class' and divsion='$division'")->result(); ?>
		<option value="">Select</option>
