...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Examination Time Table</li>
			</ol>
		</div><!--/.row-->
...
<?php } ?>				
		...
		<tr  style="background-color: #cc4a2c;color: white;"><th colspan="4" style="padding:5px; height:auto; text-align:center;"><?php echo $class->exam_name.'&nbsp;&nbsp;Class:&nbsp;&nbsp;'.$class->class.'('.$class->division.')'; ?> <span style="float:right">
			<?php 
		  if(isset($_SESSION['PRINCIPLE_ID'])) { 
 if($_SESSION['USERTYPE']=='clerk'){
 ?>
 ...
 <?php }  }?>
		...
		<tr style="background-color: #cc4a2c;color: white;"><th style="padding:5px; height:auto;">Date</th><th style="padding:5px; height:auto;">Day</th ><th style="padding:5px; height:auto;">Subject</th>
