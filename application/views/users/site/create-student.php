...
<div class="container main">			
		...
		<form role="form" method="post"  id="pincodemangement">
		 ...
		 <div class="form-group col-md-3">
            ...
            <input type="text" id="gr_code"  name="gr_code" maxlength="16" autcomplete="off" class="form-control">
            <span id="gr_codee" style="color:red;"></span> </div>
			
			<div class="form-group col-md-3">
            <label class="control-label" for="name">Admission No </label>
            <input type="text" id="admission_no"  name="admission_no" maxlength="16" autcomplete="off" class="form-control">
