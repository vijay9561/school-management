...
<style>
  ...
  <div class="col-md-2">
    ...
    <a href="<?php echo site_url(); ?>schools_invoice_details" class="btn btn-danger"> Back</a></div>
  <div class="row">
    <?php $id=$_GET['invoice_id']; $in=$this->db->query("select i.id,i.po_number,i.valid_from,i.til_date,i.payment_terms,i.registration_charges,i.software_charges,i.data_entry_charges,i.maintenance_charges,i.customization_charges,i.other_charges,i.pid,i.created_date,i.reactivation_charges,p.Principle_school_name,p.Principle_email,p.Principle_mobile_no,p.Principle_schools_city,p.address,i.invoice_no,p.sales_id from tbl_invoice i inner join tbl_principle p on i.pid=p.Pid where i.id='$id'")->row();
	  $total_amount=$in->software_charges+$in->data_entry_charges+$in->maintenance_charges+$in->customization_charges+$in->other_charges+$in->reactivation_charges;
    ...
    margin-left: 7px;" />
            ...
            <th style="font-size:18px;border-left-style: none;" colspan="4"><p style="margin-left:10px; color:#000; width:330px;">SCHOOL MANAGEMENT</p>
        <p style="margin-left:10px; font-size:14px; color:#000000;font-weight: normal;">Fl No 05, S No 43/46, Savitri Vihar B Wing<br />
         ...
         <!-- <tr>
          ...
          <tr>
            <td style="padding-left:5px; padding-right:5px;">1<br />2<br />3<br />4<br />5<br />6</td>
            <td style="padding-left:5px; padding-right:5px;width: 461px;">Software Charges<br />Data Entry Charges<br />Maintenance (AMC ) Charges<br />Customization Charges<br />Reactivation Charges<br />Other Charges</td>
            <td style="padding-left:5px; padding-right:5px;">&nbsp;</td>
            <td style="padding-left:5px; padding-right:5px;">
			
                <?php if(!empty($in->software_charges)) { echo $in->software_charges;}else{ echo 0; } ?><br />
