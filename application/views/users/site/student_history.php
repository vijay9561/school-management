...
$mysqluery=$this->db->query("select *from tbl_student_history where  (pid='".$currentrecords[0]->login_id."' OR pid='".$currentrecords[0]->Pid."') and divsion='$division' and sub_cast='$sub_caste' and Student_class_division='$class' and  Student_year='$year' order by Student_name asc")->result();
...
$mysqluery=$this->db->query("select *from tbl_student_history where  (pid='".$currentrecords[0]->login_id."' OR pid='".$currentrecords[0]->Pid."') and Student_class_division='$class' and  sub_cast='$sub_caste' order by Student_name asc")->result();
}
...
$mysqluery=$this->db->query("select *from tbl_student_history where  (pid='".$currentrecords[0]->login_id."' OR pid='".$currentrecords[0]->Pid."') and Student_class_division='$class' and  Student_year='$year' order by Student_name asc")->result();
}
}else{
if($class=='all'){
