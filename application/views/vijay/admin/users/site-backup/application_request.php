...
<div class="alert bg-success" role="alert">
			<svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg><?php echo $_SESSION['SUCESSMSG']; ?><a href="#" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a></div>
...
<textarea name="application_description"  id="application_description" class="form-control" style="resize:none" rows="6"></textarea> 
</div>
<div class="form-group">
