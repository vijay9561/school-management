...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        <div class="panel-heading"><h3 style="color: white;font-size: 25px;text-align: center;margin-top: 6px;">Add New Student</h3></div>
			 <div class="panel-body">
		
		<form role="form" method="post"  id="pincodemangement">
          <div class="form-group">
            <label>Aadhar No  <b style="color:red;">*</b></label>
		 ...
		 <div class="form-group">
		  ...
		  <div class="form-group">
            ...
            <input type="text" id="Student_roll_no"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" name="Student_roll_no" onchange="Student_roll_nor()" maxlength="30" autcomplete="off" required="required" class="form-control">
          ...
          <div class="form-group">
            ...
            <input type="text" id="Parent_mobile_no" name="Parent_mobile_no" onchange="Parent_mobile_nor()" maxlength="50" required="required" class="form-control">
...
function date_of_birth_wordr{ if($('#gender').val()==''){}else{ $('#genderr').html(' '); }}
