...
$mysqluery=$this->db->query("select *from notification where division='".$division."' and class_name='".$class."' and pid='".$Pid."' and notification_type='individual' order by nid desc LIMIT ".$pageLimit." , ".$setLimit)->result();
...
$page_url="?";
$ci= get_instance();
$query = $ci->db->query("SELECT COUNT(*) as totalCount FROM notification  where division='".$division."' and pid='".$Pid."' and class_name='".$class."' and notification_type='individual' order by nid asc")->result();
