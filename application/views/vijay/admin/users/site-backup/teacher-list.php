...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	   ...
	   <tr><th>Created Date:</th><td><?php echo date('d-m-Y',strtotime($t[0]->Date)); ?></td></tr>
		...
		<div class="col-md-8">
		<div class="panel panel-primary">
        <div class="panel-heading"><h3 style="color: white;font-size: 25px;text-align: center;margin-top: 6px;">Teacher Update</h3></div>
			 <div class="panel-body">
		...
		<input type="hidden" name="Tid" id="Tid" value="<?php echo $techers[0]->Tid; ?>" />
         ...
         <div class="form-group">
            ...
            <input type="password" id="Teacher_password" name="Teacher_password" value="<?php echo $techers[0]->Teacher_password; ?>" onchange="Teacher_passwordr()" maxlength="50" required="required" class="form-control">
		   ...
		   <option value="<?php echo $di->year; ?>"><?php echo $di->year; ?></option>	
			...
			<div class="form-group">
            <label>Address </label>
            <input type="text" id="address" name="address" maxlength="20" value="<?php echo $techers[0]->address; ?>" class="form-control">
		...
		<div class="table-responsive">
		    ...
		    <table id="datatable" class="table table-striped table-bordered">
					...
					<td><?php echo $row->gender; ?></td>
						...
						<td><?php if(!empty($row->Teacher_profile_image)){ ?>
	   <img src="<?php echo base_url() ?>assets/teacher/<?php echo $row->Teacher_profile_image; ?>" style="height:60px;width:60px;" />
	   <?php }else{ ?>
