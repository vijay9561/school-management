...
<tr>
<td style="width:100px;">No : <?php echo $nirgam_uttra->nirgam_no; ?></td>
...
font-size: 18px;color: #000; font-weight:bold;margin-left: 170px;">-: Nirgam Utara Form School  :-</span><br />
<span style="font-weight:bold; margin-left:300px;color:#000; font-size:16px; float:right;">Date :<?php echo date('d.m.Y'); ?></span>
</td>
</tr>
</table>
  <table border="1" style="border-collapse: collapse; width:100%; padding:10px; color:#000;font-size:11px;">
  <tr><th style="padding:5px;">Reg.No</th>
  <th style="padding:5px;">Student's Name in full </th>
  <th style="padding:5px;">Mother's Name </th>
  <th style="padding:5px;">Religion</th>
  <th style="padding:5px;">Caste</th>
  <th style="padding:5px;">Place of Birth </th>
  <th style="padding:5px;">Date of Birth (figure/words)</th>
  <th style="padding:5px;"> Old School Name</th>
  <th style="padding:5px;">Certificate of Date </th>
  <th style="padding:5px;">The class inserted </th>
  <th style="padding:5px;">Progress </th>
  <th style="padding:5px;">Conduct</th>
  <th style="padding:5px;">School leaving date  </th>
	   <th style="padding:5px;">Leaving Class and Class  </th>
      <th style="padding:5px;">Reason for leaving School</th>
  ...
  <table style="width:100%;">
  <br /><br />
  <tr><td style="width:600px;"></td><td style="margin-right:100px; font-weight:bold;">Clerk</td> <td style="margin-left:400px; text-align:right; font-weight:bold;">Headmaster </td></tr>
  </table>
</div>
