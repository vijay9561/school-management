...
<div class="container main">			
	   ...
	   <tr></tr>
		...
		<tr>
		<td>2</td>
		<td><input type="text"  name="fees_type[]" placeholder="Fees Type" class="form-control" /></td>
		<td><input type="text"  name="total_fees[]" autocomplete="off"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  placeholder="Total Fees" class="form-control" /></td>
		<td><input type="text"  name="paid_fees[]" autocomplete="off"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  placeholder="Paid Fees" class="form-control" /></td>
	<td><input type="text"  name="created_date[]"   placeholder="Paid Date" autocomplete="off" class="form-control datepicker" /></td>
		</tr>
	...
	<td><input type="text"  name="created_date[]"   placeholder="Paid Date" autocomplete="off" class="form-control datepicker" /></td>
		...
		<tr>
		<td>4</td>
		<td><input type="text"  name="fees_type[]"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  placeholder="Fees Type" class="form-control" /></td>
		<td><input type="text"  name="total_fees[]"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  placeholder="Total Fees" class="form-control" /></td>
		<td><input type="text"  name="paid_fees[]"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  placeholder="Paid Fees" class="form-control" /></td>
	<td><input type="text"  name="created_date[]"   placeholder="Paid Date" autocomplete="off" class="form-control datepicker" /></td>
		</tr>
		...
		<tbody>
		<tr>
		<?php $i=1; foreach($fees_type as $row){  if($i==1){?>
		<td><?php echo $i;  ?></td>
