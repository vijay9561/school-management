<?php 
if((isset($_SESSION['PRINCIPLE_ID'])) || (isset($_SESSION['TEACHER_ID'])) || (isset($_SESSION['PARENT_ID'])) || (isset($_SESSION['SALES_ID'])))
  { ?>
			...
			<div id="passwordSuccess" class="alert alert-success"  style="display:none;"></div>
                <div class="form-group">
                  <label class="">Old Password <b style="color:red;">*</b></label>
                     ...
                     <input type="password" style="text-transform: none;" class="form-control"  maxlength="10"  onChange="remove_error_oldpassword()" ng-model="user.oldPassword" id="oldPassword" name="oldPassword">
                ...
                <div class="form-group">
                  ...
                  <input type="password" style="text-transform: none;" class="form-control" onChange="remove_error_newpassword()" onKeyUp="CheckPasswordStrength(this.value)"  maxlength="10"  ng-model="user.newPassword" id="newPassword" name="newPassword">
               ...
               <input type="password" style="text-transform: none;" class="form-control"  maxlength="10" onChange="remove_errror_renpassword()"  ng-model="user.newPassword1" id="newPassword1" name="newPassword1">
...
<?php }else{ ?>
<script>window.location='<?php echo site_ulr(); ?>'; </script>
<?php } ?>
<script>
