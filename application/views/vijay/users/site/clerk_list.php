	   ...
	   <tr><th>Created Date:</th><td><?php echo $t[0]->Date; ?></td></tr>
		...
		<input type="hidden" name="Pid" id="Pid" value="<?php echo $techers[0]->Pid; ?>" />
          ...
          <div class="form-group">
            ...
            <input type="text" id="Teacher_email" style="text-transform: none;"  name="Teacher_email"  value="<?php echo $techers[0]->Principle_email; ?>" onchange="Teacher_emailr()" maxlength="50" required="required" class="form-control">
          ...
          <div class="form-group">
            ...
            <input type="password" style="text-transform: none;" id="Teacher_password" name="Teacher_password" value="<?php echo $techers[0]->Principle_password; ?>" onchange="Teacher_passwordr()" maxlength="50" required="required" class="form-control">
