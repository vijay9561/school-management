...
<div class="container">			
		...
		<input type="email" name="email" id="email" style="text-transform: none;" onchange="emailr()" class="form-control" placeholder="" />
		...
		<textarea type="text" name="message" id="message" style="text-transform: none;" onchange="messager()" class="form-control" placeholder=""  style="resize:none;"></textarea>
