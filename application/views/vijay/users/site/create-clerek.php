...
<div class="container main">			
		...
		<input type="hidden" name="principleid" id="principleid" value="<?php echo $_SESSION['PRINCIPLE_ID']; ?>" />
          ...
          <div class="form-group">
            ...
            <input type="text" id="Teacher_email" style="text-transform: none;"  name="Teacher_email" onchange="Teacher_emailr()" maxlength="50" required="required" class="form-control">
          ...
          <div class="form-group">
			...
			<div class="form-group">
            <label>Address </label>
            <input type="text" id="address" name="address" maxlength="20" required="required" class="form-control">
