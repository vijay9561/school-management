...
<div class="container main">			
	...
	<textarea name="notification_name" id="notification_name" style="text-transform: none;"  onchange="notification_namer()" class="form-control"></textarea>
	...
	<div class="form-group">
	<label class="control-label" for="name">Notification Name <b style="color:red;"> *</b></label>
	<textarea name="notification_name" id="notification_name" style="text-transform: none;"  onchange="notification_namer()" class="form-control"><?php echo $not->notification_name; ?></textarea>
	<span id="notification_namer" style="color:#FF0000"></span>
	</div>
	<div class="form-group">
	<label class="control-label" for="name">Start  Date <b style="color:red;"> *</b></label>
