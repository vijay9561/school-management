...
<div class="container main">			
	...
	<?php $techers=$this->db->query("select *from tbl_parent where Ptid='".$_SESSION['PARENT_ID']."'")->result(); ?>
	   <?php if(!empty($techers[0]->Student_profile_picture)){ ?>
	   <img src="<?php echo base_url() ?>assets/student/<?php echo $techers[0]->Student_profile_picture; ?>" style="height:150px;width:100%;" />
	   <?php }else{ ?>
	   ...
	   <?php } ?>
		...
		<tr><th>Name:&nbsp;</th><td><?php echo $techers[0]->Student_name; ?></td><th>Adhar Card</th><td><?php echo $techers[0]->adhar_card; ?></td></tr>
		<tr><th>Mother Name&nbsp; </th>&nbsp;<td><?php echo $techers[0]->mother_name; ?></td><th>Student Year </th><td><?php echo $techers[0]->Student_year; ?></td></tr>
		<tr><th>Roll No:&nbsp;</th><td><?php echo $techers[0]->Student_roll_no; ?></td><th>DOB</th><td><?php echo $techers[0]->dob; ?></td></tr>
		<tr><th>Mobile No:&nbsp;</th><td><?php echo $techers[0]->Parent_mobile_no; ?></td><th>Pan Card</th><td><?php echo $techers[0]->pan_no; ?></td></tr>
		<tr><th>Class Name:&nbsp;</th><td><?php echo $techers[0]->Student_class_division; ?></td><th>Division</th><td><?php echo $techers[0]->divsion; ?></td></tr>
		<tr><th>Old School Name&nbsp;</th><td><?php echo $techers[0]->old_schools; ?></td><th>Account No</th><td><?php echo $techers[0]->account_no; ?></td></tr>
		<tr><th>Bank Name</th>&nbsp;<td><?php echo $techers[0]->bank_no; ?></td><th>IFC Code</th><td><?php echo $techers[0]->ifc_code; ?></td></tr>
		<tr><th>Address</th>&nbsp;<td><?php echo $techers[0]->address; ?></td><th>Resdential Address</th><td><?php echo $techers[0]->redensital_address; ?></td></tr>
		<tr><th>Caste</th>&nbsp;<td><?php echo $techers[0]->cast; ?></td><th>Sub Caste</th><td><?php echo $techers[0]->sub_cast; ?></td></tr>
		</table>
		</div>
		</div>
...
function principle_registrations(){
		...
		var emailpattern = /^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/;
			...
			if(schools_name==''){
			$("#schools_namer").html('Please select class');
			$("#schools_name").focus();
			return false;
			}
