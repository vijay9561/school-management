<div class="container main">			
		...
		<div class="col-md-12">
		 <div class="panel panel-primary">
            <div class="panel-heading"><h3 style="color: white;font-size:18px;text-align: center;margin-top: 6px;">Schools Registration</h3></div>
		...
		<div class="form-group col-md-6">
			<label class="control-label" for="name">Schools Name <b style="color:red;">*</b></label>
		...
		<?php } ?>
			...
			<div class="form-group col-md-6">
			<label class="control-label" for="name">Schools Address <b style="color:red;">*</b></label>
          ...
          <div class="form-group col-md-6">
			...
			<div class="row">
			<div class="form-group col-md-6">
			<label class="control-label" for="name">Mobile Number <b style="color:red;">*</b></label>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" id="Principle_email" style="text-transform: none;"  name="Principle_email" onchange="Principle_emailr()" maxlength="50" required="required" class="form-control">
          ...
          <div class="form-group col-md-6">
            <select type="text" id="sales_id" name="sales_id" onchange="sales_idr()" maxlength="50" required="required" class="form-control">
			<?php $tbl_sales_users=$this->db->query("select name,email,id from tbl_sales_users")->result(); ?>
			<option value="">Select Sales Users<b style="color:red;">*</b></option>
			<option value="0">Individual Registration</option>
...
function principle_registrations(){
		...
		var emailpattern = /^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/;
           ...
           if(Principle_school_name==''){
			...
			if(sales_id==''){
			$("#sales_idr").html('Please select sales users');
			$("#sales_id").focus();
			return false;
			}
