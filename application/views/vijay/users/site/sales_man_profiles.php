	...
	<?php $techers=$this->db->query("select *from tbl_sales_users where id='".$_SESSION['SALES_ID']."'")->result(); ?>
		...
		<input type="hidden" name="id" id="id" value="<?php echo $techers[0]->id; ?>" />
          <div class="row">
            ...
            <input type="email" id="email" name="email" style="text-transform: none;"  value="<?php echo $techers[0]->email; ?>" onchange="emailr()" maxlength="50" required="required"  class="form-control">
            <span id="emailr" style="color:red;"></span> </div>
			<div class="form-group col-md-6">
            <label>Password <b style="color:red;">*</b></label>
            <input type="password" style="text-transform: none;" id="password" name="password" value="<?php echo $techers[0]->password; ?>" onchange="passwordr()" maxlength="50" required="required"  class="form-control">
