...
<div class="container main">			
        ...
        <div class="panel-heading"><h3 style="color: white;font-size:18px;text-align: center;margin-top: 6px;">Teacher Registration</h3></div>
		...
		<div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" id="Teacher_email" name="Teacher_email" style="text-transform: none;"  onchange="Teacher_emailr()" maxlength="50" class="form-control">
            <span id="Teacher_emailr" style="color:red;"></span> </div>
          <div class="form-group col-md-4">
            <label  class="control-label" for="name">Password <b style="color:red;">*</b></label>
            <input type="password" style="text-transform: none;" id="Teacher_password" name="Teacher_password" onchange="Teacher_passwordr()" maxlength="50" required="required" class="form-control">
          ...
          <div class="form-group col-md-4">
            ...
            <span id="schools_namer" style="color:red;"></span> </div>
					...
					<div class="row">
			<div class="form-group col-md-4">
			   <label  class="control-label" for="name">Select Division</label>
		   ...
		   <option value="<?php echo $di->divison_name; ?>"><?php echo $di->divison_name; ?></option>	
			<?php } ?>
			 ...
			 <div class="form-group col-md-4">
			  <label  class="control-label" for="name">Select Class Year</label>
