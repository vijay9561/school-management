...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<?php } ?>
          ...
          <div class="form-group">
            ...
            <input type="password" id="Principle_password" name="Principle_password" value="<?php echo $principle_details[0]->Principle_password; ?>" onchange="Principle_passwordr()" maxlength="50" required="required"  class="form-control">
	   ...
	   <span id="Principle_schools_imager1" style="color:red;"></span>
		...
		<!-- /.row -->
        <?php }elseif(isset($_GET['getinvoice_details'])){ ?>
        <div class="panel pane-default">
        <div class="panel-heading">Create Invoice</div>
         <div class="panel-body">
         <form method="post" enctype="multipart/form-data" action="<?php echo site_url(); ?>supper_admin_controller/generate_invoice_details">
				  <input type="hidden"  name="pid" value="<?php echo $_GET['getinvoice_details']; ?>" />
				   <div class="row">
					<div class="form-group col-md-6">
                      <label class="control-label" for="name">Valid From</label>
                  <input type="text" id="valid_from" value="" name="valid_from" autocomplete="off"  maxlength="200" required class="form-control schoolleavingdate">
                    </div>
                    <div class="form-group col-md-6">
                      <label class="control-label" for="name">Valid Till</label>
                  <input type="text" id="til_date" value="" name="til_date" autocomplete="off"  maxlength="200" required class="form-control schoolleavingdate">
                    </div>
                    </div>
                   <!-- <div class="row">
					<div class="form-group col-md-6">
                      <label class="control-label" for="name">Payment Terms</label>
                  <input type="text" id="payment_terms" value="" name="payment_terms" autocomplete="off" maxlength="200" required class="form-control">
                    </div>
					
					  <div class="form-group col-md-6">
                      <label class="control-label" for="name">Registration Charges</label>
                  <input type="text" id="registration_charges" value="" name="registration_charges" autocomplete="off"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="200" required class="form-control">
                    </div>
                    </div>-->
                    <div class="row">
					<div class="form-group col-md-6">
                      <label class="control-label" for="name">Software Charges</label>
                  <input type="text" id="software_charges" value="" name="software_charges" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" autocomplete="off"  maxlength="200" required class="form-control">
                    </div>
					<div class="form-group col-md-6">
                      <label class="control-label" for="name">Data Entry Charges</label>
                  <input type="text" id="data_entry_charges" value="" name="data_entry_charges" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" autocomplete="off"  maxlength="200" required class="form-control">
                    </div>
					</div>
                    <div class="row">
					<div class="form-group col-md-6">
                      <label class="control-label" for="name">Maintenance (AMC ) Charges</label>
                  <input type="text" id="maintenance_charges" value="" name="maintenance_charges" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" autocomplete="off"  maxlength="200" required class="form-control">
                    </div>
					<div class="form-group col-md-6">
                      <label class="control-label" for="name">Customization Charges</label>
                  <input type="text" id="customization_charges" value="" name="customization_charges" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  autocomplete="off" maxlength="200" required class="form-control">
                    </div></div>
					<div class="row">
                    <div class="form-group col-md-6">
                      <label class="control-label" for="name">Reactivation Charges</label>
                  <input type="text" id="reactivation_charges" value="" name="reactivation_charges" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  autocomplete="off" maxlength="200" required class="form-control">
                    </div>
					<div class="form-group col-md-6">
                      <label class="control-label" for="name">Other Charges</label>
                  <input type="text" id="other_charges" value="" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" name="other_charges" autocomplete="off"  maxlength="200" required class="form-control">
                    </div>
                    </div>
                <div class="form-group">
		    ...
		    <table id="datatable" class="table table-striped table-bordered">
					  ...
					  <?php $serial = ($pageLimit * $setLimit) + 1;
					   ...
					   ?>
				        ...
				        <td><?php echo $row->Principle_school_name;  $tbl_invoice=$this->db->query("select id from tbl_invoice where pid='$row->Pid'")->result();?></td>
                                        <td></td>
					   ...
					   <a href="<?php echo site_url(); ?>admin-principle?action=<?php echo $row->Pid; ?>"  class="btn btn-primary" title="Edit" ><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
						  <a href="#" onclick="return deletepincodes(<?php echo $row->Pid; ?>)" class="btn btn-danger" title="Delete" ><span class="glyphicon glyphicon-trash"></span></a>  <a href="<?php echo site_url(); ?>admin-principle?getinvoice_details=<?php echo $row->Pid; ?>" class="btn btn-primary" ><i class="fa fa-plus"> Create Invoice (<?php echo count($tbl_invoice); ?>)</i></a>
						  </td>
                        </tr>
