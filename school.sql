...
(9, 9, 'not every', 'active', '2019-02-02 16:21:54', 'individual', 1, '7', 'D', 'Chiku Jadhav', '343434231289', '1005');
...
--
-- Table structure for table `school_payment`
--
...
CREATE TABLE `school_payment` (
  ...
  `payment_type` enum('Registration Charges','Annual Charges','Other Charges') NOT NULL,
  `dates` datetime NOT NULL,
  `payment_method` enum('Online','Cheque') NOT NULL,
  `payment_status` enum('PAID','PENDING','DISAPPROVE') NOT NULL,
  `inovice_id` int(11) NOT NULL,
  `note` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `school_payment`
--

INSERT INTO `school_payment` (`id`, `school_id`, `txid`, `payment_amount`, `currency`, `payment_id`, `payment_type`, `dates`, `payment_method`, `payment_status`, `inovice_id`, `note`) VALUES
(1, 21, 'a7892372d1fc46f5a95d725625881313', 1000, 'INR', 'MOJO9110H05A80747175', 'Registration Charges', '2019-01-10 05:47:05', 'Online', 'PAID', 0, ''),
(3, 22, '7d701ce8dd314dd4b78eae27510a8064', 1000, 'INR', 'MOJO9110X05A80747193', 'Registration Charges', '2019-01-10 06:12:46', 'Online', 'PAID', 0, ''),
(4, 23, 'd9134eb78b744f3e9dd6a826a0007087', 1000, 'INR', 'MOJO9111P05A46696580', 'Registration Charges', '2019-01-11 12:52:14', 'Online', 'PAID', 0, ''),
(5, 20, '58da984467a64c68a5a88faef4aaa798', 1000, 'INR', 'MOJO9111U05A46696736', 'Registration Charges', '2019-01-11 16:38:56', 'Online', 'PAID', 0, ''),
(6, 1, '3340421f9e994ef084a18f5da0817849', 1300, 'INR', 'MOJO9114S05A19222269', 'Annual Charges', '2019-01-14 10:27:06', 'Online', 'PAID', 0, ''),
(7, 1, '225a972ca270432e87ab9e8e2f0e8b96', 746, 'INR', 'MOJO9116W05A32407427', 'Annual Charges', '2019-01-16 05:11:51', 'Online', 'PAID', 5, 'testing'),
(8, 21, '99bfa413cb1043b3a4c8582ab4f53df3', 1000, 'INR', 'MOJO9119V05A32864404', 'Registration Charges', '2019-01-19 10:29:22', 'Online', 'PAID', 0, '');
...
(633, 0, 0, 'A', 2019, '02', '2019-02-02 16:19:01', '2019-02-02', 'active', '7', '', 1, 'D', 58),
(634, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-02', 'active', '7', '', 1, 'D', 7),
(635, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-02', 'active', '7', '', 1, 'D', 9),
(636, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-02', 'active', '7', '', 1, 'D', 23),
(637, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-02', 'active', '7', '', 1, 'D', 33),
(638, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-02', 'active', '7', '', 1, 'D', 37),
(639, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-02', 'active', '7', '', 1, 'D', 40),
(640, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-01', 'active', '7', '', 1, 'D', 7),
(641, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-01', 'active', '7', '', 1, 'D', 9),
(642, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-01', 'active', '7', '', 1, 'D', 23),
(643, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-01', 'active', '7', '', 1, 'D', 33),
(644, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-01', 'active', '7', '', 1, 'D', 37),
(645, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-01', 'active', '7', '', 1, 'D', 40),
(646, 0, 4, 'P', 2019, '02', '2019-02-02 00:00:00', '2019-02-01', 'active', '7', '', 1, 'D', 58),
(647, 0, 0, 'P', 2019, '03', '2019-03-09 06:52:41', '2019-03-09', 'active', '7', '', 1, 'D', 58),
(648, 0, 4, 'P', 2019, '03', '2019-03-09 00:00:00', '2019-03-09', 'active', '7', '', 1, 'D', 7),
(649, 0, 4, 'P', 2019, '03', '2019-03-09 00:00:00', '2019-03-09', 'active', '7', '', 1, 'D', 9),
(650, 0, 4, 'P', 2019, '03', '2019-03-09 00:00:00', '2019-03-09', 'active', '7', '', 1, 'D', 23),
(651, 0, 4, 'P', 2019, '03', '2019-03-09 00:00:00', '2019-03-09', 'active', '7', '', 1, 'D', 33),
(652, 0, 4, 'P', 2019, '03', '2019-03-09 00:00:00', '2019-03-09', 'active', '7', '', 1, 'D', 37),
(653, 0, 4, 'P', 2019, '03', '2019-03-09 00:00:00', '2019-03-09', 'active', '7', '', 1, 'D', 40);
...
(4, 2000.00, 1900.00, 5, '2019-02-02', 1, 'D', '7', 58);
...
(14, 4, 'School Fees', 0.00, 1900.00, 0.00, '2019-02-02'),
(15, 4, 'Examination Fees', 0.00, 900.00, 0.00, '2019-02-02'),
(16, 4, 'Examination Fees', 0.00, 100.00, 0.00, '2019-02-02');
...
CREATE TABLE `tbl_invoice` (
  ...
  `created_date` date NOT NULL,
  `status` enum('PAID','UNPAID','DISAPPROVE') NOT NULL,
  `school_status` enum('PAID','UNPAID','PENDING','DISAPPROVE') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, '', '2018-02-01', '2019-02-01', '50% Advance Payment Against Invoice', 1, 1, 0, 0, 0, 0, 0, 14, 'VSM-47861', '2018-02-21', 'PAID', 'UNPAID'),
(2, '', '2018-02-01', '2018-02-28', '100 % advance amount', 10, 10, 10, 10, 10, 0, 10, 12, 'VSM-34701', '2018-02-26', 'PAID', 'UNPAID'),
(3, '', '2018-02-01', '2018-02-28', '50 Percentage', 10, 10, 10, 10, 10, 0, 10, 14, 'VSM-40454', '2018-02-26', 'PAID', 'UNPAID'),
(4, '', '2018-02-01', '2018-02-26', 'percentage', 10, 10, 10, 10, 10, 10, 10, 14, 'VSM-71222', '2018-02-26', 'PAID', 'UNPAID'),
...
INSERT INTO `tbl_principle` (`Pid`, `Principle_name`, `reg_no`, `Principle_email`, `Principle_password`, `Principle_school_name`, `Principle_schools_image`, `Principle_mobile_no`, `Principle_schools_city`, `Date`, `todate`, `Status`, `data_operators`, `adhar_card`, `pan_card`, `monthly_salary`, `acount_no`, `ifc_code`, `dob`, `address`, `login_id`, `aternative_phone`, `land_line_number`, `gender`, `establish_year`, `signature`, `schools_slogan`, `board_of_director`, `sales_id`, `from_date`, `to_date`) VALUES
(1, 'Er Vijay Jadhav1', '433555323432', 'vijay171819@gmail.com', '123456', 'सरस्वती प्राथमिक विध्यामंदीर ,प्रकाश नगर लातूर ', 'vmbss_logo_6487.jpeg', '9158680769', 'लातूर (महारष्ट्)', '2017-07-29 00:00:00', '0000-00-00', 'active', 'principal', '', '', 0, '', '', '0000-00-00', 'pune', 0, '', '02466219064', 'Male', 1966, 'IMG-20190129-WA0001_1905.jpg', 'एकता शिक्षण वर्ग ', 'बाल विकास प्रसारक मंडळ लातूर द्वारा  संचालित', 0, '2018-03-11', '2019-03-11');
...
--
-- Indexes for table `school_payment`
--
ALTER TABLE `school_payment`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `school_payment`
--
ALTER TABLE `school_payment`
...
--
ALTER TABLE `tbl_attendance`
  MODIFY `aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=654;
...
--
ALTER TABLE `tbl_parent`
  MODIFY `Ptid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
